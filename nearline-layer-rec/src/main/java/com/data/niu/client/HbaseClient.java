...
public class HbaseClient {
     ...
     * @throws Exception
     */
    public static void putData(String tablename, String rowkey, String famliyname,String column,String data) throws IOException {
        Table table = conn.getTable(TableName.valueOf(tablename));
    ...
    public static void main(String[] args) throws IOException {
        ...
        hbaseClient.createTable("test1","basic");
        hbaseClient.putData("test1","1","basic","sex","1");
        hbaseClient.putData("test1","1","basic","age","28");
